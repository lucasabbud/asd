...
public class Calculator extends Dialog
{
	...
	protected void onCreate(Bundle savedInstanceState) {		
		...
		Button b1 = (Button)findViewById(R.id.btnDsc);
		...
		bAdd.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				sum++;
				qty.setText(Integer.toString(sum).toString());
			}
		});
...
//				TextView tvTax = (TextView)view.findViewById(R.id.TextTax);
				...
				String priceStr2 = priceStr.replace(",", ".");
				float priceval = Float.valueOf(priceStr2);
...
//				float pricetax = 1+(Float.valueOf(taxStr)/100);
				float totalval = qtyval * priceval;
